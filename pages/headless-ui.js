  ...
  return (
    <div className="container mx-auto md:px-1 lg:px-2 2xl:px-4">
      ...
      <div className="mx-auto md:px-10 lg:px-20 2xl:px-40">
        ...
        <br />
        <h2 className="font-bold text-3xl">Yes, we have done it!</h2>
        <br />
        <p className="text-xl leading-8">
        ...
        <br />
        <h2 className="font-bold text-3xl">Headless component will rescue!</h2>
        <br />
        <p className="text-xl leading-8">
        ...
        <br />
        <br />
        <p className="text-xl leading-8 mb-16">
