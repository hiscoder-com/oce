...
function SidePanel({ license, homepage, repository, owner, release }) {
  return (
    <div className="flex flex-col justify-between w-full">
      ...
      <div className="flex items-center h-8 mb-4 pl-3 rounded bg-primary-100 text-base font-semibold">
        {license}
      </div>
      <div className="text-xs text-text-500">Homepage</div>

      <div className="flex items-center justify-between h-8 mb-4 px-3 rounded bg-primary-100 text-base font-semibold">
